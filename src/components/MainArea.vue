                ...
                <div class="calendar-wrapper anim-y">
                    <div class="calendar">
                        ...
                        <div class="day project-design">3
                            <div class="project-detail design">Create 3 illustrations for blog post about design trends
                            </div>
                        </div>
                        <div class="day">4</div>
                        <div class="day">5</div>
                        ...
                        <div class="day project-develop">7
                            <div class="project-detail develop">Take part in course about future design trends and new
                                technologies
                            </div>
                        </div>
                        <div class="day">8</div>
                        ...
                        <div class="day project-finance">23
                            ...
                            <div class="project-detail finance">Redesign project ui interface for clients and get feedback
                            </div>
                            <div class="popup-check">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
...
import InboxContainer from './InboxContainer.vue';
