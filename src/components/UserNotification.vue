<template>
  <div class="user-notification">
      ...
      <a-popover position="bottom">
        ...
        <template #content>
          <a-list size="small" :bordered="false">
            <a-list-item v-for="(email, index) in mails" :key="index">
              发件人：{{ email.mailAddress }}<br>收件时间：{{ email.date }}
            </a-list-item>
            <a-list-item><strong>......
              </strong></a-list-item>
          </a-list>
    ...
    <div class="notify alert">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" @click="() => this.$notification.success({
        title: '系统通知',
        content: '暂时不知道通知什么,建议V我50￥,我再告诉你吧！',
        closable: true,
        style: { width: '400px' }
      })">
        <path
...
const mails = reactive([{
  mailAddress: 'dnslint@gmail.com',
  date: '2023-12-12',
}, {
  mailAddress: '231552245@gmail.com',
  date: '2024-09-12',
}]);
// 用户信息设置
const handleClick = () => {
